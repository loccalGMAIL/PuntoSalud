    ...
    public function run(): void
    {
        $patients = [
            [
                ...
                'medical_notes' => 'Alérgica a la penicilina',
                'is_active' => true,
            ],
            [
                'first_name' => 'Carlos',
            ...
            [
                ...
                'medical_notes' => 'Diabética tipo 2, medicación diaria',
                'is_active' => true,
            ],
            [
                'first_name' => 'Roberto',
                ...
                'medical_notes' => 'Hipertensión arterial, control mensual',
                'is_active' => true,
            ],
            [
                'first_name' => 'Lucía',
            ...
            [
                ...
                'health_insurance' => null,
                'health_insurance_number' => null,
                'medical_notes' => 'Sin antecedentes relevantes',
                'is_active' => false, // Paciente inactivo para testing
            ],
            [
                'first_name' => 'Elena',
                'last_name' => 'Torres',
                ...
                'medical_notes' => 'Embarazo de 12 semanas',
                'is_active' => true,
            ],
            [
                'first_name' => 'Diego',
                ...
                'medical_notes' => 'Operado de apendicitis en 2020',
                'is_active' => true,
            ],
        ];
