...
<template>
    <AuthBase title="Crear una cuenta" description="Ingresá tus datos para crear una cuenta">
        <Head title="Registro" />
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            ...
            <div class="text-center text-sm text-muted-foreground">
                ¿Ya tenés una cuenta?
                <TextLink :href="route('home')" class="underline underline-offset-4" :tabindex="6">Iniciar sesión</TextLink>
            </div>
        </form>
    </AuthBase>
</template>
